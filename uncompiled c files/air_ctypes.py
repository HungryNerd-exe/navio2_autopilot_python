...
def initialize_sensors():
    ...
    adc_lib = ctypes.CDLL('/home/pi/ctypes_tests/ADC.so')
    imu_lib = ctypes.CDLL('/home/pi/ctypes_tests/AccelGyroMag.so')
    baro_lib = ctypes.CDLL('/home/pi/ctypes_tests/Barometer.so')
    ubl_lib = ctypes.CDLL('/home/pi/ctypes_tests/gps.so')
    # # #
...
def servo_loop(servo):
    ...
    rcin_lib = ctypes.CDLL('/home/pi/ctypes_tests/RCInput.so')
    servo_lib = ctypes.CDLL('/home/pi/ctypes_tests/servo.so')
